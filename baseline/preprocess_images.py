...
if __name__ == "__main__":
    print("Preprocessing images (150,150)...")
    fast_image_resize("../data/train/images/", "../data/train/images_resized_150/", output_size=(150, 150))
    print("train done going to test")
    fast_image_resize("../data/test/images/", "../data/test/images_resized_150/", output_size=(150, 150))

    print("Preprocessing images (1000,1000)...")
    fast_image_resize("../data/train/images/", "../data/train/images_resized_1000/", output_size=(1000, 1000))
    print("train done going to test")
    fast_image_resize("../data/test/images/", "../data/test/images_resized_1000/", output_size=(1000, 1000))